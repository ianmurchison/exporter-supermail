<img src="https://raw.githubusercontent.com/Supernova-Studio/exporter-supermail/master/readme-icon.png" alt="Supernova Logo" style="max-width:100%;">
...
In order to make the Supermail available for your organization so you can start generating code for your HTML emails, please follow the installation guide in our [developer documentation](https://developers.supernova.io/using-exporters/installing-exporters).
...
Please read through the [existing issues](https://github.com/Supernova-Studio/exporter-supermail/issues) before you open a new issue! It might be that we have already discussed it before. If you are sure your request wasn't mentioned just yet, proceed to [open a new issue](https://github.com/Supernova-Studio/exporter-supermail/issues) and fill in the required information. Thank you!
...
- [(this) Supermail](https://github.com/Supernova-Studio/exporter-supermail)
